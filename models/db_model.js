...
class DBModel {
  ...
  setup(){
    let CREATE_STUDENT_TABLE = `CREATE TABLE IF NOT EXISTS students (id INTEGER PRIMARY KEY AUTOINCREMENT,firstname TEXT NOT NULL UNIQUE,lastname TEXT,email TEXT, phone TEXT, cohort_id INTEGER NOT NULL, FOREIGN KEY(cohort_id) REFERENCES cohorts (id));`
